...
export const DATAMODEL_SECTIONS: DatamodelSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "Traject_GlobalID / Traject_Code",
        label: "Traject linkage",
        type: "GUID / String",
        description: "GlobalID is the current join field; traject_code is derived in the UI until the backend exposes it.",
        status: "Mock / transitional",
      },
      {
